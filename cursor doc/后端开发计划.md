...
- [ ] **子任务 4**: update_tenant和delete_tenant方法
  ```python
  # 逐一实现并测试
  ```
...
- [ ] **子任务 2**: POST /tenants端点
  ```python
  # AI提示: "实现创建租户API端点，使用TenantService.create_tenant"
  # 包含: 请求验证、异常处理、标准响应格式
  ```

- [ ] **子任务 3**: GET /tenants/{tenant_id}端点
  ```python
  # 实现获取租户详情API
...
#### 🔧 M4.2 上下文管理服务
- [ ] **子任务 1**: ContextManager基础
  ```python
  # AI提示: "创建app/services/context_manager.py"
  # 功能: 构建LLM所需的会话上下文
  ```

- [ ] **子任务 2**: build_context方法
  ```python
  # AI提示: "实现上下文构建算法"
